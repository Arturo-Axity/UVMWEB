...
describe(" Acceso al Portal Alumno ", () => {
  ...
  //ESTADO DE CUENTA
  it(" Ver Estado de Cuenta", () => {
    master.verEstado(2500);
  });

  it("Estado de Cuenta - Ver Pagos Banner 7", () => {
    master.verPagos7(2500);
  });

  it("Estado de Cuenta - Ver Pagos Banner 9", () => {
    master.verPagos9(2500);
  });

  it("Estado de Cuenta - Ver detalle de Historial de Pagos", () => {
  ...
  //Ver metodos de pago
  it(" Estado de Cuenta - Ver metodos de pago ", () => {
    master.metodosPago(2500);
  });

  it(" Estado de Cuenta - Método de pado CoDi ", () => {
    master.codi(2500);
  });

  //REFERENCIA BANCARIA
  it(" Ver Referencia Bancaria ", () => {
    master.verReferencia(2500);
  });

  it(" Descargar Referencia Bancaria ", () => {
