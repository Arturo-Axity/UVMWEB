class BibliotecaVirtualPO {
  ...
  cancelar(t) {
    ...
    cy.get('[data-testid="item-icon-bibliotecas"]').click();
    ...
    cy.wait(tiempo);
    cy.screenshot("Biblioteca virtual - Cancelar", { capture: "fullPage" });
  }
  ...
  irLink(t) {
    ...
    cy.wait(tiempo);
    cy.screenshot("Biblioteca virtual - Ir a link", { capture: "fullPage" });
  }
} //final

export default BibliotecaVirtualPO;
